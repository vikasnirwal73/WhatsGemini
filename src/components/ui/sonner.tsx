    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success: "group-[.toaster]:!bg-secondary group-[.toaster]:!text-foreground group-[.toaster]:!border-success/40",
          error: "group-[.toaster]:!bg-secondary group-[.toaster]:!text-foreground group-[.toaster]:!border-destructive/40",
        },
      }}
      {...props}
    />
